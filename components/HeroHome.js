      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-4xl mx-auto text-center pb-12 md:pb-16">
            ...
            Empowering students with free quizzes and premium mock papers.
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
            Welcome to BangExams, your ultimate destination for acing competitive exams! At BangExams, we offer a comprehensive platform designed to empower students on their academic journey.
            </p>
