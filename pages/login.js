        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            <img
              ...
              alt="Workflow"
            />
            <h2 className="mt-6 text-center text-3xl font-extrabold text-blue-200">Sign in to your account</h2>
            <div className="mt-2 text-center text-sm text-gray-300">
              Or{' '}
              <Link href={'/signup'} className="font-medium text-gray-300 hover:text-gray-200 cursor-pointer">Signup</Link>
            </div>
          </div>
              ...
              <button
                ...
                onClick={async (e)=>{
                  ...
                  if(res.error){
                    ...
                    toast.success("Great! You logged in. Access our bangexams content")
                  }
                }}
